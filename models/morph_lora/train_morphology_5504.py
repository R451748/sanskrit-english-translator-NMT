...
print("=" * 70)
print("MORPHOLOGY-CONDITIONED INDIC TRANS2 LoRA")
print("PROPOSED EXPERIMENT — 5504")
print("=" * 70)
...
def build_source(record):
    ...
    # Sanskrit
    #
    # We then append morphology information.
    # --------------------------------------------------------
...
validation_dataset = MorphologyDataset(
    validation_records,
    tokenizer,
    MAX_SOURCE_LENGTH,
    MAX_TARGET_LENGTH
...
print("=" * 70)
print("STARTING MORPHOLOGY LoRA TRAINING")
print("=" * 70)
...
# ============================================================
# 25. SAVE TRAINING SUMMARY
# ============================================================

summary = {

    "experiment":
        "IndicTrans2 Morphology LoRA 5504",
...
print("=" * 70)
print("MORPHOLOGY 5504 TRAINING COMPLETED")
print("=" * 70)
...
print(
    "It uses Sanskrit + morphology "
    "information with IndicTrans2 LoRA."
)
