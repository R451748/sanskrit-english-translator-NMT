...
from model import MorphologyAwareTransformer
...
CHECKPOINT = (
    "models/proposed/checkpoints/best_model.pt"
)
...
print("=" * 70)
print("MORPHOLOGY-AWARE TRANSFORMER")
...
print(
    "\nGenerating beam-search translations..."
)
...
print("BEAM SEARCH EVALUATION COMPLETE")
